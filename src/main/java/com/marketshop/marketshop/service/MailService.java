...
public class MailService {
    ...
    private static final String senderEmail = "princejhs200@gmail.com";
    ...
    public MailDto createMailAndChangePassword(String memberEmail) {
        ...
        dto.setTitle("당근마켓 임시비밀번호 안내 이메일 입니다.");
        dto.setMessage("안녕하세요. 당근마켓 임시비밀번호 안내 관련 이메일 입니다." + " 회원님의 임시 비밀번호는 "
