...
import com.marketshop.marketshop.dto.QMainItemDto;
import com.marketshop.marketshop.entity.Item;
import com.marketshop.marketshop.entity.QItem;
import com.marketshop.marketshop.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom{
    ...
    private BooleanExpression searchByCategory(String searchItemCategory, String searchQuery) {
        ...
        } else if(StringUtils.equals("[전자기기 용품]", searchItemCategory)){
            return QItem.item.itemCategory.like("[전자기기 용품]" + searchQuery);
        } else if(StringUtils.equals("[장난감]", searchItemCategory)) {
            return QItem.item.itemCategory.like("[장난감]" + searchQuery);
        } else if(StringUtils.equals("[음식]", searchItemCategory)) {
            return QItem.item.itemCategory.like("[음식]" + searchQuery);
